...
export class RepoService {
    private repos: Repo[] = [
        { 
            ...
            url: "https://github.com/mattWStevens/WeatherReport"
        },
        {
            name: "LearnArmAssembly",
            ...
            url: "https://github.com/keith-E/LearnArmAssembly"
        },
        {
            name: "Hangman",
            ...
            url: "https://github.com/mattWStevens/Hangman"
        },
        {
            name: "TicTacToe",
            ...
            url: "https://github.com/mattWStevens/TicTacToe"
        },
        {
            ...
            url: "https://github.com/mattWStevens/SimpleCalculator"
        },
        {
            name: "HigherEdJobsWebScraper",
            description: "Web Scraper for HigherEdJobs and Data Visualizations.",
            url: "https://github.com/mattWStevens/HigherEdJobsWebScraper"
        }
    ];
